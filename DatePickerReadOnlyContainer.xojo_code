#tag WebPage
Begin WebContainer DatePickerReadOnlyContainer
   Compatibility   =   ""
   Cursor          =   0
   Enabled         =   True
   Height          =   241
...
#tag WindowCode
	...
	#tag Method, Flags = &h1
		Protected Sub ShowPicker()
		  Dim D As new Date
		  If TextField1.Text <> "" then
		    If ParseDate(TextField1.Text, D) then
...
#tag Events TextField1
	#tag Event
		Sub MouseDown(X As Integer, Y As Integer, Details As REALbasic.MouseEvent)
		  ...
		  If self.Height > TextField1.Top + TextField1.Height + 10 then
		    HidePicker()
		  else
		    ShowPicker()
		  End If
